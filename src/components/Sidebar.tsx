  ...
  const MENU_STRUCTURE: MenuItem[] = [
    {
      ...
      subItems: [
        ...
        { id: 'dashboard-indicators', label: 'Metas & Indicadores', roles: ['admin', 'gerente'] },
        ...
        { id: 'insights', label: 'Inteligência de IA', roles: ['admin', 'gerente'] },
      ]
    },
    {
      id: 'agenda',
      ...
      subItems: [
        { id: 'agenda-main', label: 'Grade de Horários', roles: ['admin', 'gerente', 'barbeiro', 'cliente'] },
        { id: 'agenda-appointments', label: 'Lista de Agendamentos', roles: ['admin', 'gerente'] },
        { id: 'agenda-recurring', label: 'Clientes Recorrentes', roles: ['admin', 'gerente'] },
        { id: 'agenda-availability', label: 'Escalas de Trabalho', roles: ['admin', 'gerente'] },
        { id: 'agenda-blocks', label: 'Bloqueios de Agenda', roles: ['admin', 'gerente'] },
        { id: 'agenda-operations', label: 'Painel de Fluxo', roles: ['admin', 'gerente'] },
      ]
    },
    {
      id: 'comandas',
      ...
      roles: ['admin', 'gerente', 'barbeiro'],
      subItems: [
        { id: 'comandas-nova', label: 'Lançar Comanda', roles: ['admin', 'gerente', 'barbeiro'] },
        ...
        { id: 'comandas-fiadas', label: 'Controle de Fiados', roles: ['admin', 'gerente'] },
    ...
    },
    {
      ...
      subItems: [
        ...
        { id: 'cadastros-assinantes', label: 'Clube de Assinaturas', roles: ['admin', 'gerente'] },
        { id: 'cadastros-pacotes', label: 'Pacotes de Serviços', roles: ['admin', 'gerente'] },
        { id: 'fidelidade-programa', label: 'Fidelidade & Cashback', roles: ['admin', 'gerente', 'cliente'] },
        { id: 'cadastros-cupons', label: 'Cupons de Desconto', roles: ['admin', 'gerente'] },
        { id: 'cadastros-lembretes', label: 'Lembretes de Equipe', roles: ['admin', 'gerente'] },
        { id: 'cadastros-mensagens', label: 'Mensagens p/ Clientes', roles: ['admin', 'gerente'] },
        { id: 'cadastros-noticias', label: 'Feed & Promoções', roles: ['admin', 'gerente'] },
        { id: 'cadastros-satisfacao', label: 'Avaliações de Clientes', roles: ['admin', 'gerente'] },
      ]
    },
    {
      id: 'comissoes',
      label: 'Profissionais & Comissões',
      icon: <Briefcase size={20} />,
      roles: ['admin', 'gerente', 'barbeiro'],
      subItems: [
        { id: 'cadastros-profissionais', label: 'Cadastro de Barbeiros', roles: ['admin', 'gerente'] },
        { id: 'financeiro-comissoes', label: 'Fechamento de Comissões', roles: ['admin', 'gerente'] },
    ...
    },
    {
      ...
      roles: ['admin', 'gerente'],
      subItems: [
        { id: 'relatorios-geral', label: 'Resultado Consolidado', roles: ['admin', 'gerente'] },
        { id: 'relatorios-agendamentos', label: 'Desempenho de Agendamentos', roles: ['admin', 'gerente'] },
        { id: 'relatorios-clientes', label: 'Fidelização e Frequência', roles: ['admin', 'gerente'] },
    ...
    },
    {
      ...
      subItems: [
        ...
        { id: 'admin-logs', label: 'Registro de Atividades', roles: ['admin'] },
      ]
    }
  ];
